// Generated from C:/Users/hp/IdeaProjects/SqlAntlr/src/main/resources/antlr4/MariaDBLexer.g4 by ANTLR 4.13.2
package antlr4;
...
public class MariaDBLexer extends Lexer {
	...
	public static final int
		...
		DELIMITER=46, DESC=47, DESCRIBE=48, DETERMINISTIC=49, DIAGNOSTICS=50, 
		DISTINCT=51, DISTINCTROW=52, DROP=53, EACH=54, ELSE=55, ELSEIF=56, EMPTY=57, 
		ENCLOSED=58, ESCAPED=59, EXCEPT=60, EXISTS=61, EXIT=62, EXPLAIN=63, FALSE=64, 
		FETCH=65, FOR=66, FORCE=67, FOREIGN=68, FROM=69, FULLTEXT=70, GENERATED=71, 
		GET=72, GRANT=73, GROUP=74, HAVING=75, HIGH_PRIORITY=76, HISTOGRAM=77, 
		IF=78, IGNORE=79, IGNORED=80, IN=81, INDEX=82, INFILE=83, INNER=84, INOUT=85, 
		...
		PARTITION=130, PRIMARY=131, PACKAGE=132, PROCEDURE=133, PURGE=134, RANGE=135, 
		READ=136, READS=137, REFERENCES=138, REGEXP=139, RELEASE=140, RENAME=141, 
		REPEAT=142, REPLACE=143, REQUIRE=144, RESIGNAL=145, RESTRICT=146, RETAIN=147, 
		RETURN=148, REVOKE=149, RIGHT=150, RLIKE=151, SCHEMA=152, SCHEMAS=153, 
		SELECT=154, SET=155, SEPARATOR=156, SHOW=157, SIGNAL=158, SKIP_=159, SPATIAL=160, 
		SQL=161, SQLEXCEPTION=162, SQLSTATE=163, SQLWARNING=164, SQL_BIG_RESULT=165, 
		SQL_CALC_FOUND_ROWS=166, SQL_SMALL_RESULT=167, SSL=168, STACKED=169, STARTING=170, 
		STATEMENT=171, STRAIGHT_JOIN=172, SYSTEM=173, SYSTEM_TIME=174, TABLE=175, 
		TERMINATED=176, THEN=177, TO=178, TRAILING=179, TRIGGER=180, TRUE=181, 
		UNDO=182, UNION=183, UNIQUE=184, UNLOCK=185, UNSIGNED=186, UPDATE=187, 
		USAGE=188, USE=189, USING=190, VALUES=191, VERSIONING=192, WHEN=193, WHERE=194, 
		WHILE=195, WITH=196, WRITE=197, XOR=198, ZEROFILL=199, TINYINT=200, SMALLINT=201, 
		MEDIUMINT=202, MIDDLEINT=203, INT=204, INT1=205, INT2=206, INT3=207, INT4=208, 
		INT8=209, INTEGER=210, BIGINT=211, REAL=212, DOUBLE=213, PRECISION=214, 
		FLOAT=215, FLOAT4=216, FLOAT8=217, DECIMAL=218, DEC=219, NUMERIC=220, 
		DATE=221, TIME=222, TIMESTAMP=223, DATETIME=224, YEAR=225, CHAR=226, VARCHAR=227, 
		NVARCHAR=228, NATIONAL=229, BINARY=230, VARBINARY=231, TINYBLOB=232, BLOB=233, 
		MEDIUMBLOB=234, LONG=235, LONGBLOB=236, TINYTEXT=237, TEXT=238, MEDIUMTEXT=239, 
		LONGTEXT=240, ENUM=241, VARYING=242, SERIAL=243, YEAR_MONTH=244, DAY_HOUR=245, 
		DAY_MINUTE=246, DAY_SECOND=247, HOUR_MINUTE=248, HOUR_SECOND=249, MINUTE_SECOND=250, 
		SECOND_MICROSECOND=251, MINUTE_MICROSECOND=252, HOUR_MICROSECOND=253, 
		...
		STATS_PERSISTENT=640, STATS_SAMPLE_PAGES=641, STATUS=642, STORAGE=643, 
		...
		COLON_SYMB=1169, DOLLAR_SIGN=1170, ANY_CHAR=1171, CHARSET_REVERSE_QOUTE_STRING=1172, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"DECLARE", "DEFAULT", "DELAYED", "DELETE", "DELIMITER", "DESC", "DESCRIBE", 
			...
			"DOLLAR_SIGN", "ANY_CHAR", "QUOTE_SYMB", "CHARSET_REVERSE_QOUTE_STRING", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'DELETE'", "'DELIMITER'", "'DESC'", "'DESCRIBE'", "'DETERMINISTIC'", 
			...
			"'LEVEL'", "'LIST'", "'LOCAL'", "'LOCALES'", "'LOGFILE'", "'LOGS'", "'MASTER'", 
			...
			"'STATS_SAMPLE_PAGES'", "'STATUS'", "'STORAGE'", "'STORED'", "'STRING'", 
			"'SUBCLASS_ORIGIN'", "'SUBJECT'", "'SUBPARTITION'", "'SUBPARTITIONS'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"DATABASES", "DECLARE", "DEFAULT", "DELAYED", "DELETE", "DELIMITER", 
			...
			"COMMA", "SEMI", "AT_SIGN", "ZERO_DECIMAL", "ONE_DECIMAL", "TWO_DECIMAL", 
			"SINGLE_QUOTE_SYMB", "DOUBLE_QUOTE_SYMB", "REVERSE_QUOTE_SYMB", "COLON_SYMB", 
			"DOLLAR_SIGN", "ANY_CHAR", "CHARSET_REVERSE_QOUTE_STRING", "FILESIZE_LITERAL", 
	...
	private static final String _serializedATNSegment1 =
		...
		"\u0000MMmm\u0002\u0000VVvv\u0002\u0000PPpp\u0002\u0000XXxx\u0002\u0000"+
		"JJjj\u0002\u0000QQqq\b\u0000GGKKMMTTggkkmmtt\u0007\u0000$$..09AZ__az\u0080"+
		"\u8000\uffff\u0002\u0000++--\u0006\u0000$$09AZ__az\u0080\u8000\uffff\u0005"+
		"\u0000$$AZ__az\u0080\u8000\uffff\u0002\u0000\"\"\\\\\u0002\u0000\'\'\\"+
		"\\\u0001\u0000``\u0003\u000009AFaf\u0001\u000009\u0001\u000001\u0002\u0000"+
		"..09\u0003\u00000:AFaf\u371e\u0000\u0001\u0001\u0000\u0000\u0000\u0000"+
